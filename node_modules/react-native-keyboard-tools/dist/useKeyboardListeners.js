...
export const useKeyboardListeners = ({ keyboardAwareViewRef, restoreScrollOnKeyboardHide, }) => {
    ...
    const onKeyboardWillHide = useCallback(() => {
        ...
        keyboardHideTimer.current.timerId = setTimeout(() => {
            ...
            if (keyboardAwareViewRef &&
                ...
                const yOffset = Math.max(keyboardAwareViewRef.current.contentOffset.y - keyboardHeight, 0);
    ...
    useEffect(() => {
        ...
        const keyboardWillShowSubscribtion = KeyboardEventsObj.addListener("keyboardWillShow", onKeyboardWillShow);
        const keyboardWillHideSubscribtion = KeyboardEventsObj.addListener("keyboardWillHide", onKeyboardWillHide);
        return () => {
